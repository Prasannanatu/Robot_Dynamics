...
% Modified by A. Rosendo <arosendo@wpi.edu>
clear, clc, close all
addpath('utils');
...
G1 = [0.0382 0 0 0 0 0;
    ...
    0 0 0 m1 0 0 ;
    0 0 0 0 m1 0;
    0 0 0 0 0 m1;]; % ...; Spatial Inertia Matrix for link 1
G2 = [0.076 0 0 0 0 0;
    0 0.076 0 0 0 0;
    0 0 0.0026 0 0 0;
    0 0 0 m2 0 0 ;
    0 0 0 0 m2 0;
    0 0 0 0 0 m2;]; % ...; Spatial Inertia Matrix for link 2
G3 = [0.002 0 0 0 0 0;
    0 0.002 0 0 0 0;
    0 0 0.0026 0 0 0;
    0 0 0 m3+1 0 0 ;
    0 0 0 0 m3+1 0;
    0 0 0 0 0 m3+1;]; % ...; Spatial Inertia Matrix for link 3
